...
static inline void attachInterruptVector(IRQ_NUMBER_t irq,
        void (*function)(void)) __attribute__((always_inline, unused));
...
static inline void attachInterruptVector(enum IRQ_NUMBER_t irq,
        void (*function)(void)) __attribute__((always_inline, unused));
...
// XX.YY: page XYZ
#define IMXRT_DCP		(*(IMXRT_REGISTER32_t *)0x402FC000)
#define DCP_CTRL			(IMXRT_DCP.offset000)
#define DCP_CTRL_SET		(IMXRT_DCP.offset004)
#define DCP_CTRL_CLR		(IMXRT_DCP.offset008)
#define DCP_CTRL_TOG		(IMXRT_DCP.offset00C)
#define DCP_STAT			(IMXRT_DCP.offset010)
#define DCP_STAT_SET		(IMXRT_DCP.offset014)
#define DCP_STAT_CLR		(IMXRT_DCP.offset018)
#define DCP_STAT_TOG		(IMXRT_DCP.offset01C)
#define DCP_CHANNELCTRL		(IMXRT_DCP.offset020)
#define DCP_CHANNELCTRL_SET	(IMXRT_DCP.offset024)
#define DCP_CHANNELCTRL_CLR	(IMXRT_DCP.offset028)
#define DCP_CHANNELCTRL_TOG	(IMXRT_DCP.offset02C)
#define DCP_CAPABILITY0		(IMXRT_DCP.offset030)
#define DCP_CAPABILITY1		(IMXRT_DCP.offset040)
#define DCP_CONTEXT			(IMXRT_DCP.offset050)
#define DCP_KEY				(IMXRT_DCP.offset060)
#define DCP_KEYDATA			(IMXRT_DCP.offset070)
#define DCP_PACKET0			(IMXRT_DCP.offset080)
#define DCP_PACKET1			(IMXRT_DCP.offset090)
#define DCP_PACKET2			(IMXRT_DCP.offset0A0)
#define DCP_PACKET3			(IMXRT_DCP.offset0B0)
#define DCP_PACKET4			(IMXRT_DCP.offset0C0)
#define DCP_PACKET5			(IMXRT_DCP.offset0D0)
#define DCP_PACKET6			(IMXRT_DCP.offset0E0)

#define IMXRT_DCP0		(*(IMXRT_REGISTER32_t *)0x402FC100)
#define DCP0_CMDPTR			(IMXRT_DCP0.offset000)
#define DCP0_SEMA			(IMXRT_DCP0.offset010)
#define DCP0_STAT			(IMXRT_DCP0.offset020)
#define DCP0_STAT_SET		(IMXRT_DCP0.offset024)
#define DCP0_STAT_CLR		(IMXRT_DCP0.offset028)
#define DCP0_STAT_TOG		(IMXRT_DCP0.offset02C)
#define DCP0_OPTS			(IMXRT_DCP0.offset030)
#define DCP0_OPTS_SET		(IMXRT_DCP0.offset034)
#define DCP0_OPTS_CLR		(IMXRT_DCP0.offset038)
#define DCP0_OPTS_TOG		(IMXRT_DCP0.offset03C)

#define IMXRT_DCP1		(*(IMXRT_REGISTER32_t *)0x402FC140)
#define DCP1_CMDPTR			(IMXRT_DCP1.offset000)
#define DCP1_SEMA			(IMXRT_DCP1.offset010)
#define DCP1_STAT			(IMXRT_DCP1.offset020)
#define DCP1_STAT_SET		(IMXRT_DCP1.offset024)
#define DCP1_STAT_CLR		(IMXRT_DCP1.offset028)
#define DCP1_STAT_TOG		(IMXRT_DCP1.offset02C)
#define DCP1_OPTS			(IMXRT_DCP1.offset030)
#define DCP1_OPTS_SET		(IMXRT_DCP1.offset034)
#define DCP1_OPTS_CLR		(IMXRT_DCP1.offset038)
#define DCP1_OPTS_TOG		(IMXRT_DCP1.offset03C)

#define IMXRT_DCP2		(*(IMXRT_REGISTER32_t *)0x402FC180)
#define DCP2_CMDPTR			(IMXRT_DCP2.offset000)
#define DCP2_SEMA			(IMXRT_DCP2.offset010)
#define DCP2_STAT			(IMXRT_DCP2.offset020)
#define DCP2_STAT_SET		(IMXRT_DCP2.offset024)
#define DCP2_STAT_CLR		(IMXRT_DCP2.offset028)
#define DCP2_STAT_TOG		(IMXRT_DCP2.offset02C)
#define DCP2_OPTS			(IMXRT_DCP2.offset030)
#define DCP2_OPTS_SET		(IMXRT_DCP2.offset034)
#define DCP2_OPTS_CLR		(IMXRT_DCP2.offset038)
#define DCP2_OPTS_TOG		(IMXRT_DCP2.offset03C)

#define IMXRT_DCP3		(*(IMXRT_REGISTER32_t *)0x402FC1C0)
#define DCP3_CMDPTR			(IMXRT_DCP3.offset000)
#define DCP3_SEMA			(IMXRT_DCP3.offset010)
#define DCP3_STAT			(IMXRT_DCP3.offset020)
#define DCP3_STAT_SET		(IMXRT_DCP3.offset024)
#define DCP3_STAT_CLR		(IMXRT_DCP3.offset028)
#define DCP3_STAT_TOG		(IMXRT_DCP3.offset02C)
#define DCP3_OPTS			(IMXRT_DCP3.offset030)
#define DCP3_OPTS_SET		(IMXRT_DCP3.offset034)
#define DCP3_OPTS_CLR		(IMXRT_DCP3.offset038)
#define DCP3_OPTS_TOG		(IMXRT_DCP3.offset03C)
