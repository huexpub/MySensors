...
#if defined(MY_NRF5_PA_PIN)
	hwPinMode(MY_NRF5_PA_PIN, OUTPUT);
#endif
#if defined(MY_NRF5_LNA_PIN)
	hwPinMode(MY_NRF5_LNA_PIN, OUTPUT);
#endif
#if defined(MY_NRF5_CHL_PIN)
	hwPinMode(MY_NRF5_CHL_PIN, OUTPUT);
	hwDigitalWrite(MY_NRF5_CHL_PIN, MY_NRF5_CHL_MODE); // CHL = TX HIGH POWER
#endif
#if defined(MY_NRF5_CPS_PIN)
	hwPinMode(MY_NRF5_CPS_PIN, OUTPUT);
	hwDigitalWrite(MY_NRF5_CPS_PIN, MY_NRF5_CPS_MODE); // CPS = RX/TX BYPASS
#endif
#endif
...
#if defined(MY_NRF5_PA_LNA)
	hwDigitalWrite(MY_NRF5_PA_PIN, MY_NRF5_PA_DISABLED); // disable PA
	hwDigitalWrite(MY_NRF5_LNA_PIN, MY_NRF5_LNA_ENABLED); // enable LNA
#endif
#ifdef NRF52
...
{
#if defined(MY_NRF5_PA_LNA)
	hwDigitalWrite(MY_NRF5_PA_PIN, MY_NRF5_PA_ENABLED); // enable PA
	hwDigitalWrite(MY_NRF5_LNA_PIN, MY_NRF5_LNA_ENABLED); // enable LNA for ACK
#endif
	if (tx_retries > 0) {
